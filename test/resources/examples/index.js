...
const largeRing30 = generateTestCase({
  ...
  orders: [
    ...
    { sellToken: 24, buyToken: 25, sellAmount: toETH(1), buyAmount: toETH(0.99), user: 0 },
    { sellToken: 25, buyToken: 26, sellAmount: toETH(1), buyAmount: toETH(0.99), user: 1 },
    { sellToken: 26, buyToken: 27, sellAmount: toETH(1), buyAmount: toETH(0.99), user: 0 },
    { sellToken: 27, buyToken: 28, sellAmount: toETH(1), buyAmount: toETH(0.99), user: 1 },
    { sellToken: 28, buyToken: 29, sellAmount: toETH(1), buyAmount: toETH(0.99), user: 0 },
    { sellToken: 29, buyToken: 0, sellAmount: toETH(1), buyAmount: toETH(0.99), user: 1 },
  ],
  solutions: [
    {
