...
module.exports = async function (callback) {
  try {
    ...
    // Request withdraw
    console.log(
      "Request withdraw for user %s, token %s (%d)",
      user1Address,
      token1.address,
      token1.id,
    );
    ...
    await submitSolution({
      name: "Full solution",
      batchId,
      solution: solutionSubmissionParams(
    ...
    console.log(
      "Environment setup complete for BatchExchange with address ",
