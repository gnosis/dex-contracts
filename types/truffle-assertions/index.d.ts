...
declare module "truffle-assertions" {
  ...
  interface TruffleAssert {
    eventEmitted: (result: TransactionResult, eventType: string, filterOrObject?: FilterOrObject, message?: string) => void
    eventNotEmitted: (result: TransactionResult, eventType: string, filterOrObject?: FilterOrObject, message?: string) => void
    prettyPrintEmittedEvents: (result: TransactionResult, indentationSize: number) => void
    createTransactionResult: <T>(contract: Truffle.Contract<T>, transactionHash: string) => TransactionResult
