...
contract StablecoinConverter is EpochTokenLocker {
    ...
    function submitSolution(
        ...
        for (uint i = 0; i < owners.length; i++) {
            ...
            addBalanceAndProcessDueWithdraw(owners[i], tokenIdToAddressMap(order.buyToken), executedBuyAmount);
        }
    ...
    function grantRewardToSolutionSubmitter(uint feeReward) internal {
        ...
        addBalanceAndProcessDueWithdraw(msg.sender, tokenIdToAddressMap(0), feeReward);
    }
